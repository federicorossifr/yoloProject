...
public class Fields {
    ...
    public static final String YOLO_TAGS = "yolo_tags";
	public static final String BOUNDING_BOX_FEAT = "bounding_box_feat";
	public static final String RAW_FEATURES = "raw_features";
